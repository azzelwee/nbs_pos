        ...
        <div class= "main-container1">
            ...
            <div class="thebuttons">
                <form action="" method="post">
                    <button type="submit" name="" class="btn-ok10" id="altEnter" onclick="window.location.href = 'posMain.php'">Yes</button> 
                </form>
            
                    <button type="button" id="esc2" name="cancelButtons" class="btn-cancel5" onclick="window.location.href = 'posMain.php';">No</button>
                    </div>
            </div>
    </div>
